const StarRating = ({ rating, count }) => {
  ...
  return (
    <div className="flex items-center">
      ...
      {halfStar && (
        <svg key="half" className="w-4 h-4 text-yellow-400 fill-current" viewBox="0 0 20 20"><path d="M10 15l-5.878 3.09 1.123-6.545L.489 6.91l6.572-.955L10 0l2.939 5.955 6.572.955-4.756 4.635 1.123 6.545zM10 0v15l-5.878 3.09.001-6.544.001-.001L10 0z"/></svg>
      )}
      ...
      {count && <span className="ml-2 text-xs text-gray-500">({count} reviews)</span>}
    </div>
  );
};
